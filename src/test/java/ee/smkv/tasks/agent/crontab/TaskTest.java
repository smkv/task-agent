...
public class TaskTest {
    ...
    public void testParse() throws Exception {
        Task task = new CronLineParser().parse("* * * * * echo 1");
    ...
    public void testParse2() throws Exception {
        Task task = new CronLineParser().parse("23 */2 * * * echo \"Выполняется в 0:23, 2:23, 4:23 и т. д.\"");
        assertEquals("23 */2 * * *" , task.getTrigger().toString());
        assertEquals("echo \"Выполняется в 0:23, 2:23, 4:23 и т. д.\"" , task.getCommand());
    }
    @Test
    public void testParse3() throws Exception {
        Task task = new CronLineParser().parse("15 10,13 * * 1,4 echo \"Эта надпись выводится в понедельник и четверг в 10:15 и 13:15\"");
    ...
    public void testParse4() throws Exception {
        Task task = new CronLineParser().parse("0-59 * * * * echo \"Выполняется ежеминутно\"");
